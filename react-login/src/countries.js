// List of countries with their ISO code and international dial code.
// The flag emoji is derived from the 2-letter code (see flagFor below),
// so we don't have to store a flag for each one.
...
// Turn a 2-letter country code (e.g. "LB") into its flag emoji (🇱🇧)
...
// Find a country by its code (used to show the flag/dial on the Home page).
